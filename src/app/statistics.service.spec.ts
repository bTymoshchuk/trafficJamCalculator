...
describe('StatisticsService', () => {
  ...
  beforeEach(async(() => TestBed.configureTestingModule({
    providers: [{provide: GlobalService, useClass: MockGlobalService}, StatisticsService],
  ...
  it('should return spinner value ', () => {
    expect(statistics.getSpinnerValue()).toBeCloseTo(78.1, 1);
  });
  ...
  it('should return average jam duration', () => {
    expect(statistics.getAverageDuration()).toBeCloseTo( 7239064, -1);
  });
